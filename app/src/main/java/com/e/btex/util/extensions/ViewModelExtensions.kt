...
inline fun <reified VM : ViewModel> Fragment.nestedParentViewModelProvider(
    provider: ViewModelProvider.Factory
) =
    ViewModelProviders.of(parentFragment!!.parentFragment!!, provider).get(VM::class.java)

inline fun <reified VM : ViewModel> Fragment.targetViewModelProvider(
    provider: ViewModelProvider.Factory
) =
    ViewModelProviders.of(targetFragment!!, provider).get(VM::class.java)